...
const WOEID_URL = "http://zourbuth.com/tools/woeid/"
...
, weatherUrl: function weatherUrl() {
    return 'https://query.yahooapis.com/v1/public/yql?format=json&q=select * from weather.forecast where woeid="' + this._woeid + '" and u="' + this.unitToUrl() + '"'
  }
